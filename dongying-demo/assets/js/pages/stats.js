...
(function (g) {
  ...
  function render() {
    ...
    <div class="row" style="height:262px;margin-top:12px">
      ${U.panel({
      title: '飞行高度分布', sub: `海拔高 altitude · 协议必填 · 参与统计 ${U.num(S.altTotal)} 个`,
      style: 'flex:1', body: `<div id="sAlt" style="height:100%"></div>`
    })}
      ${U.panel({ title: '飞行时长统计', sub: '分钟', style: 'flex:1', body: `<div id="sDur" style="height:100%"></div>` })}
      ${U.panel({ title: '轨迹长度统计', sub: '公里', style: 'flex:1', body: `<div id="sTrack" style="height:100%"></div>` })}
    </div>
