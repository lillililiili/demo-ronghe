...
<template>
  <div class="view audit-api-view">
    <section class="panel audit-api-panel">
      <header class="ph audit-heading"><div><h2>审计日志</h2><p>操作日志不能修改或删除。导出文件包含当前筛选条件下的记录。</p></div><n-button type="primary" :loading="exporting" :disabled="!hasPermission('audit.op')" @click="exportCsv">导出 CSV</n-button></header>
