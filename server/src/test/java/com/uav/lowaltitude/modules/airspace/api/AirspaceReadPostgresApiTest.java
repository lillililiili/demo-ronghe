...
class AirspaceReadPostgresApiTest {
    ...
    void postgisUsesGeographyHalfWidthBufferRatherThanDegreeOrFullWidthGeometry() throws Exception {
        ...
        try {
            ...
            PlanRow plan = new PlanRow("plan-1", "P-1", "PENDING", null, null, "mock", null, now.minusMinutes(1), now.plusMinutes(1), "org-1", "district-1", "rv-1", "route-1", "R-1", "Route", 1, now, now, 0);
            ...
            PlanRow widthUnknown = new PlanRow("plan-width", "P-WIDTH", "PENDING", null, null, "mock", null, now.minusMinutes(1), now.plusMinutes(1), "org-1", "district-1", "rv-width", "route-width", "R-WIDTH", "Route width unknown", 1, now, now, 0);
